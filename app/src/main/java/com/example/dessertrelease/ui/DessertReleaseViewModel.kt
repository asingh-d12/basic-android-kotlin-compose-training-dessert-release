...
import com.example.dessertrelease.data.repo.UserPreferencesRepository
...
class DessertReleaseViewModel(
    ...
    companion object {
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                val app = this[AndroidViewModelFactory.APPLICATION_KEY] as DessertReleaseApplication
                DessertReleaseViewModel(app.userPreferencesRepository)
            }
        }
    }
}
